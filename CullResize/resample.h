...
{
public:
  FilteredResizeH( PClip _child, double subrange_left, double subrange_width, int target_width, int zscale, int phase, int phase2,
...
{
public:
  FilteredResizeV( PClip _child, double subrange_top, double subrange_height, int target_height, int zscale, int phase, int phase2, ResamplingFunction* func, IScriptEnvironment* env );
...
{
public:
static PClip CreateResizeH( PClip clip, double subrange_left, double subrange_width, int target_width, int zscale, int phase, int phase2,
                            ResamplingFunction* func, IScriptEnvironment* env );

static PClip CreateResizeV( PClip clip, double subrange_top, double subrange_height, int target_height, int zscale, int phase, int phase2,
                            ResamplingFunction* func, IScriptEnvironment* env );

static PClip CreateResize( PClip clip, int target_width, int target_height, int zscale, int phase, int phase2, const AVSValue* args,
