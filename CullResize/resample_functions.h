...
struct ResamplingProgram {
  ...
  ResamplingProgram(int filter_size, int source_size, int target_size, double crop_start, double crop_size, int zscale, int phase, int phase2, IScriptEnvironment2* env)
    : filter_size(filter_size), source_size(source_size), target_size(target_size), crop_start(crop_start), crop_size(crop_size), zscale(zscale), phase(phase), phase2(phase2),
...
public:
  ...
  virtual ResamplingProgram* GetResamplingProgram(int source_size, double crop_start, double crop_size, int target_size, int zscale, int phase, int phase2, IScriptEnvironment2* env);
};
